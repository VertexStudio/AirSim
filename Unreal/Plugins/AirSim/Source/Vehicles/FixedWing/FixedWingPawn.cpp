...
#include "FixedWingWheelFront.h"
#include "FixedWingWheelRear.h"
...
AFixedWingPawn::AFixedWingPawn()
{
    ...
    const auto& car_mesh_paths = AirSimSettings::singleton().pawn_paths["DefaultFixedWing"];
    ...
    // Create In-FixedWing camera component 
...
void AFixedWingPawn::setupVehicleMovementComponent()
{
...
UWheeledVehicleMovementComponent* AFixedWingPawn::getVehicleMovementComponent() const
{
    return GetVehicleMovement();
}

void AFixedWingPawn::initializeForBeginPlay(bool engine_sound)
{
    if (engine_sound)
...
void AFixedWingPawn::Tick(float Delta)
{
    Super::Tick(Delta);
...
void AFixedWingPawn::updateHUDStrings()
{
...
void AFixedWingPawn::updateInFixedWingHUD()
{
...
void AFixedWingPawn::updatePhysicsMaterial()
{
...
void AFixedWingPawn::setupInputBindings()
{
    ...
    UAirBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("MoveRight", EKeys::Right, 0.5), this,
        this, &AFixedWingPawn::onMoveRight);

    UAirBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("MoveRight", EKeys::Left, -0.5), this,
        this, &AFixedWingPawn::onMoveRight);

    UAirBlueprintLib::BindActionToKey("Handbrake", EKeys::End, this, &AFixedWingPawn::onHandbrakePressed, true);
    UAirBlueprintLib::BindActionToKey("Handbrake", EKeys::End, this, &AFixedWingPawn::onHandbrakeReleased, false);

    UAirBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("Footbrake", EKeys::SpaceBar, 1), this,
        this, &AFixedWingPawn::onFootBrake);
    ...
    //below is not needed
    //UAirBlueprintLib::BindActionToKey("Reverse", EKeys::Down, this, &AFixedWingPawn::onReversePressed, true);
    //UAirBlueprintLib::BindActionToKey("Reverse", EKeys::Down, this, &AFixedWingPawn::onReverseReleased, false);
}

void AFixedWingPawn::onMoveForward(float Val)
{
    if (Val < 0)
        onReversePressed();
    else
...
void AFixedWingPawn::onMoveRight(float Val)
{
    keyboard_controls_.steering = Val;
}

void AFixedWingPawn::onHandbrakePressed()
{
    keyboard_controls_.handbrake = true;
}

void AFixedWingPawn::onHandbrakeReleased()
{
    keyboard_controls_.handbrake = false;
}

void AFixedWingPawn::onFootBrake(float Val)
{
    keyboard_controls_.brake = Val;
}

void AFixedWingPawn::onReversePressed()
{
...
void AFixedWingPawn::onReverseReleased()
{
    if (keyboard_controls_.manual_gear < 0) {
