...
UCLASS(config = Game)
class AFixedWingPawn : public AWheeledVehicle
{
    GENERATED_BODY()
...
public:
    ...
    const msr::airlib::FixedWingApiBase::FixedWingControls& getKeyBoardControls() const
    {
...
private:
    ...
    msr::airlib::FixedWingApiBase::FixedWingControls keyboard_controls_;
