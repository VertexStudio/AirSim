...
public:
    struct FixedWingControls {
        ...
        FixedWingControls(float throttle_val, float steering_val, float brake_val, bool handbrake_val,
    ...
    struct FixedWingState {
        ...
        FixedWingState(float speed_val, int gear_val, float rpm_val, float maxrpm_val, bool handbrake_val, 
...
public:
    ...
    virtual void setFixedWingControls(const FixedWingControls& controls) = 0;
    virtual FixedWingState getFixedWingState() const = 0;
    virtual const FixedWingApiBase::FixedWingControls& getFixedWingControls() const = 0;
